...
class Kms extends CI_Controller{
  ...
  public function add()
  {
      ...
      $check_no_kk_anak = $this->m_core->get_where($this->table, array('no_kk_anak' => $this->input->post('no_kk_anak')));
      if($check_no_kk_anak->num_rows() > 0) {
          $res = array('msg' => 'No. KK Sudah Di gunakan dalam KMS', 'code' => 400);
