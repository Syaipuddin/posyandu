...
class Anak extends CI_Controller{
  ...
  function add()
  {
    ...
    $check_primary = $this->m_core->get_where($this->table, array('no_kk_anak' => $this->input->post('no_kk_anak')));
    if($check_primary->num_rows() > 0){
      $res = array('msg' => 'No KK Sudah Ada', 'code' => 500);
  ...
  function delete()
  {
    ...
    $delete = $this->m_core->delete_rows($this->table, array('no_kk_anak' => $id_target) );
    if($delete){
