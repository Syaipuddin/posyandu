...
<html lang="en-US">
    ...
    <body class="home blog" style="background-color:#e3e3e3;">
        ...
        <div id="sidebar" class="sidebar" >
            <div class="menu-left-part" style="">
                ...
                <footer>
                    <div class="footer-info">
                        © 2019 POSYANDU. <br><i class="fa fa-heart"></i> BY POSYANDU
                    </div>
                </footer>
            </div>
            <div class="menu-right-part " style="display: flex; flex-direction: column; align-items:center; gap:25px; margin-top:50px;">
                <div class="home-btn">
                    <div id="home">
                        <a href="#/dashboard" class="current" style="font-size: 32px; color: white;"><i class="fa fa-home"></i></a>
                    </div>
                </div>
                <div class="antrian-btn">
                    <div id="antrian">
                        <a href="#/antrian" style="font-size: 28px; color: white;"><i class="fa fa-list"></i></a>
                    </div>
                </div>

                <div class="logout-btn">
                    <?php if($this->session->userdata('login') === 1): ?>
                        <a href="<?= base_url('master/warga/Akun/logout') ?>" style="font-size: 28px; color: white;"><i class="fa fa-sign-out"> </i></a>
                    <?php endif; ?>    
                </div>  
