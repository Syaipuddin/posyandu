            ...
            <div class="modal-body">
                <form id="form-add-anak" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="no_kk_anak" maxlength="13" id="no_kk_anak" placeholder="NIK Anak">
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-edit-anak" method="post">
                    ...
                    <div class="form-group">
                      <label>NIK Anak</label>
                      <input type="text" class="form-control" name="no_kk_anak" maxlength="13" id="no_kk_anak_edit" placeholder="NIK Anak" readonly>
                    </div>
                    <div class="form-group">
                      <label>Nama Depan</label>
