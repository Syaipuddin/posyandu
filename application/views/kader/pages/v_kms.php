            ...
            <form id="form__add__kms" method="posts">
                <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="no_kk_anak" id="no_kk_anak" placeholder="Masukan NIK Anak" >
               ...
               <button class="btn btn-warning" type="button" id="btn__search_kk_anak"><span class="fa fa-search"></span> Cari No KK Anak</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">            
                <form id="form-edit-kms">
                    ...
                    <div class="form-group">
                        <label>NIK Anak</label>
                        <input type="text" class="form-control" id="no__kk__anak__edit" name="no_kk_anak" readOnly>
                    </div>
                    <div class="form-group">
                        <label>Berat Badan Lahir</label>
