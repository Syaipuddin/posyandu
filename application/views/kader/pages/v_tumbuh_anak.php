<div class="container-fluid">
    ...
    <div id="growth_chart_container" style="width: 100%;display:flex;justify-content:center; align-content:center;margin-top:10vh; display:none;">
        <div style="width:50%;">
            ...
            <form id="form__pertumbuhan__anak">
                <div class="col-md-4">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <label>No KK Anak</label>
                            <input type="text" class="form-control" name="no_kk_anak" id="no_kk_anak"  readOnly >
                        </div>
