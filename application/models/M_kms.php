...
class M_kms extends CI_Model {
    ...
    {
        $query = "SELECT a.no_kms, a.no_kk_anak AS kk_anak_number,  a.tanggal_terdaftar, a.berat_badan_lahir AS bb , a.panjang_badan_lahir AS pb, 
                         b.no_kk , b.jenis_kelamin AS jk ,
                         CONCAT(b.nama_depan,' ',  b.nama_belakang) AS nama_lengkap
                  FROM
                  t_kms a LEFT JOIN t_anak b ON a.no_kk_anak = b.no_kk_anak
                  WHERE 
    ...
    {
        $query = "SELECT a.no_kk_anak, CONCAT(a.nama_depan ,' ', a.nama_belakang) as nama_lengkap , a.jenis_kelamin, a.tgl_lahir,
    ...
    public function fetch_detail_kms($kms)
    {
        $query = "SELECT a.no_kms, a.berat_badan_lahir as bb_lahir, a.panjang_badan_lahir as pb_lahir,
                         b.no_kk_anak, CONCAT(b.nama_depan, ' ', b.nama_belakang) as nama_lengkap, b.jenis_kelamin as jk, b.tgl_lahir,
                  ...
                  FROM t_kms a 
                         LEFT JOIN t_anak b ON a.no_kk_anak = b.no_kk_anak
