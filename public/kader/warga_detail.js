              ...
              <div class="widget-flot-bg shadow-reset mg-t-30 animated fadeInLeft">
                  <div class="admin-widget-flot-ch">
                      ...
                      <div style="margin-top: 30px;">
                        <p><strong> No.KK Anak </strong>: ${item.no_kk_anak}</p>
                      ...
                      <button class="btn btn-danger btn-xs btn-delete-anak" data-id="${item.no_kk_anak}"> Hapus </button>
                      <button class="btn btn-warning btn-xs btn-edit-anak" data-id="${item.no_kk_anak}" data-nama_depan="${item.nama_depan}" data-nama_blkg="${item.nama_belakang}" data-jenis_kelamin="${item.jenis_kelamin}" data-tgl_lahir="${item.tgl_lahir}"> Edit </button>
                  </div>
              </div>
            `;
          });
...
var SetupEventWargaDetail = (function(UI) {
    ...
    $('#show-anak').on('click', '.btn-edit-anak', function() {
      ...
      $('#no_kk_anak_edit').val($(this).data('id'))
    ...
    $('#form-add-anak').on('keypress','#no_kk_anak', function(e) {
    ...
    $('#form-add-anak').validate({
      ...
      messages:{
        no_kk_anak:{
          ...
          minlength: 'No KK Anak kurang dari 13 Digits'
        },
        nama_depan:{
