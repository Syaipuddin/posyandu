            ...
            html += `
             <div style="display:flex; align-items: center; justify-content: space-between;">
                <div class="card" style="">
                    <h5 class="" style="color: #3B1E54;"> ${item.nama_kegiatan} </h3>
                    <p class="" style="color: #3B1E54;"> ${item.lokasi} </p>
                </div>

                <div style="">
                      <button class="btn btn-info btn-block btn__show__modal__antri" style="background-color: #3B1E54; border-color: #3B1E54;" > Ambil No. Antri </button>
                </div>
            </div>
            `;
       })
